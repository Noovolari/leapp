...
!!! Info
    ...
    If you want to know how Leapp generates and refresh short-term credentials refer to the [credentials generation](/0.9.0/security/credentials-generation/aws/) section in the documentation.
