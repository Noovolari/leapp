...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/api/v1/plugins',
            ...
            function PluginRoutes_pluginList(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const controller = new PluginRoutes();


              const promise = controller.pluginList.apply(controller, validatedArgs as any);
        ...
        app.get('/api/v1/plugins/:pluginId',
            ...
            function PluginRoutes_downloadPlugin(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.downloadPlugin.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/api/v1/plugins',
            ...
            function PluginRoutes_createPlugin(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.createPlugin.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/api/v1/plugins/:pluginId',

            function PluginRoutes_updatePlugin(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.updatePlugin.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
